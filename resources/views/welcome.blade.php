                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown active">
                            ...
                            <ul class="active dropdown-menu">
                                ...
                                <li class="active"><a href="index2.html">Home V.1</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="testimonials-dark.html">testimonials</a></li>
                                <li><a href="our-team-dark.html">our team</a></li>
                                <li><a href="pricing-dark.html">Pricing Table</a></li>
                                <li><a href="cooming-soon.html">Cooming Soon</a></li>
                                <li><a href="signup.html">Sign up</a></li>
                                <li><a href="signin.html">Sign in</a></li>
                                <li><a href="404-dark.html">404 Not Found</a></li>
                        ...
                        <li><a href="about-us-dark.html">About</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="single-service-dark.html">Single Service V.1</a></li>
                                <li><a href="single-service-v2-dark.html">Single Service V.2</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="gallery-v1-dark.html">Gallery V.1</a></li>
                                <li><a href="gallery-v2-dark.html">Gallery V.2</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="blog-left-sidebar-dark.html">Left Sidebar</a></li>
                                <li><a href="single-blog-dark.html">Single Blog V.1</a></li>
                                <li><a href="single-blog-style2-dark.html">Single Blog V.2</a></li>
                                <li><a href="single-blog-left-sidebar-dark.html">Single Blog V.3</a></li>
                            </ul>
                        </li>
                        <li><a href="contact-us-dark.html">Contact</a></li>
...
<div class="homepage-slides-wrapper">
    ...
    <div class="swiper-container swiper2">
        ...
        <div class="swiper-wrapper">
            <!-- Slides -->
            <div class="swiper-slide swiper-slide-two hero-image-1 jarallax">
                <div class="d-table">
            ...
            <div class="swiper-slide swiper-slide-two hero-image-2 jarallax">
                <div class="d-table">
                    <div class="d-table-cell">
                        <div class="container">
                            <div class="row">
            ...
            <div class="swiper-slide swiper-slide-two hero-image-3 jarallax">
                <div class="d-table">
                    <div class="d-table-cell">
                        <div class="container">
                            <div class="row">
        ...
        <div class="swiper-pagination swiper-pagination-white swiper-pagination2"></div>
    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="box">
                        ...
                        <div class="box-content">
                            ...
                            <ul class="icon">
                                ...
                                <li><a href="single-service-dark.html"><i class="fa fa-link"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 text-center">
                <a href="#" class="btn theme-btn">view all services</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="testimonial-item">
                    ...
                    <div class="quotation-profile">
                        <img src="assets/img/08m.jpg" alt="Image">
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-7">
                                <div class="blog-item-profile">
                                    <img src="assets/img/28m.jpg" alt="Image description"> <a href="#">anika rimjim</a>
                                </div>
                            </div>
                ...
                <div class="single-blog-item">
                    ...
                    <div class="blog-item-info">
                        ...
                        <div class="row">
                            <div class="col-xs-7">
                                <div class="blog-item-profile">
                                    <img src="assets/img/42w.jpg" alt="Image description"> <a href="#">anika rimjim</a>
                                </div>
                            </div>
                            <div class="col-xs-5 text-right">
                                <div class="blog-item-c-v-info">
                ...
                <div class="single-blog-item">
                    ...
                    <div class="blog-item-info">
                        ...
                        <div class="row">
                            <div class="col-xs-7">
                                <div class="blog-item-profile">
                                    <img src="assets/img/46w.jpg" alt="Image description"> <a href="#">anika rimjim</a>
                                </div>
                            </div>
                            <div class="col-xs-5 text-right">
                                <div class="blog-item-c-v-info">
